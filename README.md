...
* The "Scream" verb no longer prints garbage.
...
* Double-space is now prevented. Previously it mistakenly prevented a second space only after first letter of second word was started, as in:  WORD_L_
